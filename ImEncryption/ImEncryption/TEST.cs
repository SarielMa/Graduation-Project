...
namespace ImEncryption
{
    class TEST
    {
        ...
        {
            double aver = this.comm.dataAver(data1, num);//计算数学期望
            double aver2 = this.comm.dataAver(data2, num);//计算数学期望
            double sqerr = this.comm.meanSqErr(data1, aver, num);//计算方差
            double sqerr2 = this.comm.meanSqErr(data2, aver2, num);//计算方差
            double crr = this.cor(data1, aver, data2, aver2, num);//计算协方差
